...
VIDEO_PATH = Path("videos/cv2/cv2_mrt.mp4")

OUTPUT_PATH = Path(
    "config/cv2_rois.json"
)
...
window_name = "SmartGS CV2 ROI Calibration"
...
rois["door_3_interior"] = select_multiple_rois(
    "door_3_interior",
    (255, 0, 0)
)
...
rois["door_4_interior"] = select_multiple_rois(
    "door_4_interior",
    (0, 165, 255)
)
...
print()
print("=" * 60)
print("CV2 ROI CALIBRATION COMPLETE")
print("=" * 60)
...
print()
print(
    f"Door 3 interior ROIs: "
    f"{len(rois['door_3_interior'])}"
)

print(
    f"Door 4 interior ROIs: "
    f"{len(rois['door_4_interior'])}"
)
