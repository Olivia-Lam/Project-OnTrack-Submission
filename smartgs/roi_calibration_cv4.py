...
print()
print("=" * 60)
print("SMARTGS CV4 ROI CALIBRATION")
print("=" * 60)
...
print(
    "1. Door 1 - Left boarding"
)

print(
    "2. Door 1 - Disembarking"
)

print(
    "3. Door 1 - Right boarding"
)

print(
    "4. Door 2 - Left boarding"
)

print(
    "5. Door 2 - Disembarking"
)

print(
    "6. Door 2 - Right boarding"
)
...
print()
print("=" * 60)
print("CV4 CALIBRATION COMPLETE")
print("=" * 60)
