...
OUTPUT_PATH = Path("config/cv2_seats.json")
...
window_name = "SmartGS CV2 Seat Calibration"
...
print()
print("SMARTGS CV2 SEAT CALIBRATION")
print()
print("First: Door 3")
print("Then: Door 4")


door_3_seats = select_seats(
    "door_3"
)


door_4_seats = select_seats(
    "door_4"
)
...
print()
print("=" * 60)
print("CV2 SEAT CALIBRATION COMPLETE")
print("=" * 60)

print(
    f"Door 3 seats: {len(door_3_seats)}"
)

print(
    f"Door 4 seats: {len(door_4_seats)}"
)
