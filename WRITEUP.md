...
| A single journey can combine all three lines: Compassvale LRT → Paya Lebar MRT gave Sengkang LRT → Purple Line → Circle Line, about 26–30 min, with 2–3 route options. | One OneMap request per time, for 2026-09-19 15:30 and Monday 2026-09-21 at 08:30, 13:00 and 18:30 (made on 2026-09-19): all four returned that three-line route as the best option (29, 26, 30 and 27 min). Timetable-dependent, so the minutes will vary. We tried four candidate trips, not a sample, and chose this one because it was stable. | Try-first step 2 in the README |
